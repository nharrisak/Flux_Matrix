...
#define inNumChannels (1)
{
	...
	biquadA[0] = (pow(GetParameter( kParam_Two ),3)*20000.0)/GetSampleRate();
	if (biquadA[0] < 0.0003) biquadA[0] = 0.0003;
	Float64 clipFactor = 1.0+(pow(GetParameter( kParam_Three ),3)*2.0);
