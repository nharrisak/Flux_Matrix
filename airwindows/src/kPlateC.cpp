...
void _airwindowsAlgorithm::render( const Float32* inputL, const Float32* inputR, Float32* outputL, Float32* outputR, UInt32 inFramesToProcess ) {
	...
	dram->fixA[fix_freq] = 21.0/downRate;
	dram->fixA[fix_reso] = 0.0020736;
	dram->fixD[fix_freq] = 25.0/downRate;
	dram->fixD[fix_reso] = 0.0016384;
	dram->fixB[fix_freq] = (dram->fixA[fix_freq] + dram->fixA[fix_freq] + dram->fixD[fix_freq]) / 3.0;
	dram->fixB[fix_reso] = 0.0019285;
	dram->fixC[fix_freq] = (dram->fixA[fix_freq] + dram->fixD[fix_freq] + dram->fixD[fix_freq]) / 3.0;
	dram->fixC[fix_reso] = 0.0017834;
