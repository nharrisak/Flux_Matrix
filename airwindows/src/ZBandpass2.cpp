...
#define inNumChannels (1)
{
	...
	dram->biquadA[biq_freq] = ((pow(GetParameter( kParam_Two ),4)*14300.0f)/GetSampleRate())+0.00079f;
	float clipFactor = 1.0f - ((1.0f - GetParameter( kParam_Two ))*0.304f);
	dram->biquadA[biq_reso] = 0.314f;
	...
	dram->biquadA[biq_aB0] = K / dram->biquadA[biq_reso] * norm;
	dram->biquadA[biq_aB1] = 0.0f;
