...
void _airwindowsAlgorithm::render( const Float32* inputL, const Float32* inputR, Float32* outputL, Float32* outputR, UInt32 inFramesToProcess ) {
	...
	fixA[fix_freq] = 12.0/downRate;
	fixA[fix_reso] = 0.0015625;
	fixD[fix_freq] = 26.0/downRate;
	fixD[fix_reso] = 0.0003025; //divide num by 10!
	fixB[fix_freq] = (fixA[fix_freq] + fixA[fix_freq] + fixD[fix_freq]) / 3.0;
	fixB[fix_reso] = 0.0011425;
	fixC[fix_freq] = (fixA[fix_freq] + fixD[fix_freq] + fixD[fix_freq]) / 3.0;
	fixC[fix_reso] = 0.0007225;
