...
#define inNumChannels (1)
{
	...
	while (nSampleFrames-- > 0) {
		...
		temp = (inputSample * dram->fixA[fix_a0]) + dram->fixA[fix_sL1];
		...
		dram->biquad[biq_sL1] =  -(temp * dram->biquad[biq_b1]) + dram->biquad[biq_sL2];
